...
| `Spio-Repo-Split-Runbook.md` | [Spio Repository Split Runbook](./Spio-Repo-Split-Runbook.md) | Describe the exact preflight, copy, and post-copy sequence for moving spio out of the current workspace into pafio-repository. |
