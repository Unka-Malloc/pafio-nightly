...
- [RegistrySecurity.hpp](pafio-repository/src/SpioSecurity/RegistrySecurity.hpp)
...
Registry consumption uses the public read-side interface in [RegistrySecurity.hpp](pafio-repository/src/SpioSecurity/RegistrySecurity.hpp).
...
Remote publish uses the public write-side interface in [RegistrySecurity.hpp](pafio-repository/src/SpioSecurity/RegistrySecurity.hpp).
...
- [ResolveDefaultRegistryReadSecurity](pafio-repository/src/SpioSecurity/RegistrySecurity.hpp)
- [ResolveDefaultRegistryWriteSecurity](pafio-repository/src/SpioSecurity/RegistrySecurity.hpp)
