...
For data and resource lifecycle claims, use the centralized `styio-audit` framework as the auditable source of truth: `modules/default` plus `for-pafio-nightly`.
