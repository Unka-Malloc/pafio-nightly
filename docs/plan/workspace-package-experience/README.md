# Workspace And Package Experience Plan

**Purpose:** Manage remaining work for workspace selection, local override workflows, package metadata, discovery commands, command references, and project graph payloads.
