...
**Purpose:** Record dependency authorization boundaries for `styio-pafio`.

**Last updated:** 2026-04-24

`styio-pafio` is an Apache-2.0 C++/Python source project. Its current build and test dependency boundary is:
